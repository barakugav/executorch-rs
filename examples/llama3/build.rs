fn main() {
    ...
    println!("cargo::rustc-link-search={libs_dir}/kernels/portable/");
    println!("cargo::rustc-link-lib=static=portable_kernels");
    // println!("cargo::rustc-link-lib=static:+whole-archive=portable_ops_lib");

    println!("cargo::rustc-link-search={libs_dir}/configurations/");
    println!("cargo::rustc-link-lib=static:+whole-archive=optimized_native_cpu_ops_lib");

    println!("cargo::rustc-link-search={libs_dir}/kernels/optimized/");
    ...
    println!("cargo::rustc-link-search={libs_dir}/kernels/quantized/");
    ...
    println!("cargo::rustc-link-search={libs_dir}/extension/llm/custom_ops/");
    println!("cargo::rustc-link-lib=static:+whole-archive=custom_ops");

    // xnnpack
    println!("cargo::rustc-link-search={libs_dir}/backends/xnnpack/");
    println!("cargo::rustc-link-search={libs_dir}/backends/xnnpack/third-party/XNNPACK/");
    println!("cargo::rustc-link-search={libs_dir}/backends/xnnpack/third-party/cpuinfo/");
    println!("cargo::rustc-link-search={libs_dir}/backends/xnnpack/third-party/pthreadpool/");
