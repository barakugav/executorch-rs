...
fn generate_bindings() {
    ...
    let builder = bindgen::Builder::default()
        ...
        .blocklist_item("executorch::runtime::MemoryManager")
        ...
        .blocklist_item("executorch::runtime::Method")
        .blocklist_item("executorch::runtime::Method_.*")
        .blocklist_item("executorch::runtime::MethodMeta")
        .blocklist_item("executorch::runtime::MethodMeta_.*")
        ...
        .blocklist_item("executorch::extension::MallocMemoryAllocator")
        .opaque_type("executorch::runtime::Half")
        .blocklist_item("executorch::runtime::MemoryAllocator")
        .blocklist_item("executorch::runtime::HierarchicalAllocator")
        .blocklist_item("executorch::runtime::TensorInfo")
        .blocklist_item("executorch::runtime::TensorInfo_.*")
